...
func (s *minioCreateRetentionServant) PutFileInput(objectKey string, localFIle string) (string, error) {
	return "", nil
}
func (s *minioCreateTempDirServant) PutFileInput(objectKey string, localFIle string) (string, error) {
	return "", nil
}
func (s *minioCreateServant) PutFileInput(objectKey string, localFIle string) (string, error) {
	return "", nil
}
