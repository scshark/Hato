...
func (s *aliossCreateTempDirServant) PutFileInput(objectKey string, localFIle string) (string, error) {
	return "", nil
}
func (s *aliossCreateRetentionServant) PutFileInput(objectKey string, localFIle string) (string, error) {
	return "", nil
}
func (s *aliossCreateServant) PutFileInput(objectKey string, localFIle string) (string, error) {
	return "", nil
}
