...
func (s *hwobsCreateServant) PutFileInput(objectKey string, localFile string) (string, error) {
	input := &obs.PutFileInput{}
	input.Bucket, input.Key, input.SourceFile = s.bucket, objectKey, localFile
...
func (s *hwobsCreateRetentionServant) PutFileInput(objectKey string, localFile string) (string, error) {
	// empty
	return "", nil
}
func (s *hwobsCreateTempDirServant) PutFileInput(objectKey string, localFile string) (string, error) {
	// empty
	return "", nil
}
