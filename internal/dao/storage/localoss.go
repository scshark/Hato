...
func (s *localossCreateTempDirServant) PutFileInput(objectKey string, localFIle string) (string, error) {
	return "", nil
}
func (s *localossCreateServant) PutFileInput(objectKey string, localFIle string) (string, error) {
	return "", nil
}
