...
func (s *cosCreateTempDirServant) PutFileInput(objectKey string, localFIle string) (string, error) {
	return "", nil
}
func (s *cosCreateServant) PutFileInput(objectKey string, localFIle string) (string, error) {
	objectName := objectKey
	_, _, err := s.client.Object.Upload(
		context.Background(), objectName, localFIle, nil,
	)
	if err != nil {
		return "", err
	}
