<template>
    <div class="post-item" @click="goPostDetail(post.id)">
        <n-thing content-indented>
            ...
            <template #description v-if="post.title.length > 0">
                  <span
                      v-for="content in post.title"
                      :key="content.id"
                      class="post-text"
            ...
            <template #description v-if="post.texts.length > 0 && post.title.length === 0">
                <span
