<template>
    <div>
            ...
            >
                <div class="compose-line compose-options">
                    <div class="attachment">
                        ...
                        >
                            <template #icon>
                                <n-icon size="22" color="var(--primary-color)">
                                    <compass-outline />
                                </n-icon>
                            </template>
                        </n-button>
        ...
        <div class="compose-wrap" style="padding-bottom: 15px" v-else>
...
onMounted(() => {
    ...
    visitType.value = defaultVisitType.value;
    uploadToken.value = 'Bearer ' + localStorage.getItem('HATO_TOKEN');
});
</script>
...
.compose-textarea,.compose-textarea .n-input--textarea {
  font-size: 20px;
}

.compose-textarea .n-input__textarea-el,.compose-textarea .n-input__placeholder{
  font-size: 20px;
}
</style>